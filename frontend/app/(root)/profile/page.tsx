...
const Page = () => {
  ...
  return (
    <div className="grid flex-1 grid-cols-1 gap-4 md:grid-cols-[1fr,2.5fr]">
      ...
      <div className="flex flex-col items-center gap-4 bg-white p-8">
        ...
        <div className="grid w-full space-x-4 md:grid-cols-2">
          <LinkComponent href="/profile/edit" className="!rounded-lg">
            Edit profile
          </LinkComponent>
          <LinkComponent href="/profile/change-password" className="rounded-lg">
            Change password
          </LinkComponent>
        </div>
